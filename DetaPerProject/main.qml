...
ApplicationWindow {
    ...
    title: qsTr("Detaper") + __blank + qsTr("Version: ") + appVersion + __blank
    ...
    Popup{
        id: popupGTCoreConfigs
        contentItem: ArrayEditor{
            sectionName: qsTr("GTCoreConfigs")
            configModel: gtCoreConfigs
            Component.onCompleted: {
                init()
            }
        }
    ...
    Popup {
        ...
        contentItem: ArrayEditor {
            sectionName: qsTr("LanguagePackageNames")
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        if (rdbNormal.checked) {
                            runParameter["RunMode"] = qsTr("Normal")
                        } else {
                            runParameter["RunMode"] = qsTr("DryRun")
                        }
    ...
    menuBar: MenuBar {
        Menu {
            ...
            MenuItem {
                text: qsTr("GTCoreConfig")
                onClicked: {
                    popupGTCoreConfigs.open()
                }
            }
            MenuItem {
        ...
        Menu {
            ...
            Repeater {
                ...
                delegate: MenuItem {
                    text: modelData + (basicConfig.skin == modelData ? qsTr("    √") : "")
                    onClicked: {
