#include "detapervisionfactory.h"

DetaperVisionFactory::DetaperVisionFactory(VisionConfigManager *visionConfigManager)
{
...
LightSourceController *DetaperVisionFactory::createLSC(QString lscName)
{
    if (!wordopLscConfigMap.contains(lscName))
    {
...
SCCamera *DetaperVisionFactory::createCamera(QString cameraName, CameraConfig *cameraConfig, QObject *parent)
{
    if(cameraConfig->cameraVendor() != CameraConfig::Basler)
    {
