#ifndef PICKARMMAPDATA_H
#define PICKARMMAPDATA_H

#include "enumhelper.h"
#include "trayMap/materialdata.h"

class PickArmMapData : public MaterialData
{
    Q_OBJECT
...
public:
    ...
    Q_INVOKABLE PickArmMapData(QObject *parent = nullptr) : MaterialData(parent)
    {
        init();
    }
