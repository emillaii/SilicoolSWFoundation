#ifndef DischargeMapData_H
#define DischargeMapData_H

#include "enumhelper.h"
#include "trayMap/materialdata.h"

class DischargeMapData : public MaterialData
{
    Q_OBJECT
...
public:
    ...
    Q_INVOKABLE DischargeMapData(QObject *parent = nullptr) : MaterialData(parent)
    {
        init();
    }
