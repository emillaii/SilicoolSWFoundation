...
BasicConfigEditor{
    QtObject{
        ...
        property bool useTableToRepresentObjectArray: false
    ...
    function init(_isExpand=true)
    {
        ...
        if(configModel.configType() === ConfigElementType.ConfigObjArr){
            ...
            self.useTableToRepresentObjectArray = configModel.useTableToRepresent()
            if(self.useTableToRepresentObjectArray)
            {
    ...
    Flickable{
        visible: self.isObjectArray && self.useTableToRepresentObjectArray && isExpand && listModel.count > 0
        ...
        delegate: Rectangle{
            ...
            Loader{
                source: {
                    if(self.isObjectArray)
                    {
                        if(self.useTableToRepresentObjectArray) {
                            ...
                            return "ObjectEditorRow.qml"
                        }
                    } else {
                        "SimpleTypeArrayRow.qml";
                    }
                }
                ...
                onLoaded: {
                    ...
                    configNodes.resize()
                    if(self.isObjectArray && self.useTableToRepresentObjectArray && !configNodes.isResizeTitle){
