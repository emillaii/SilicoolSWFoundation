            ...
            ColumnLayout{
                ...
                GridView{
                    ...
                    delegate: Rectangle{
                        ...
                        color: collisionConditionsView.currentIndex == rowIndex ? "darkgray" : "transparent"
                        border.width: 1
            ...
            ColumnLayout{
                ...
                GridView{
                    ...
                    delegate: Rectangle{
                        ...
                        color: ignoreCollisionConditionsView.currentIndex == rowIndex ? "darkgray" : "transparent"
                        border.width: 1
